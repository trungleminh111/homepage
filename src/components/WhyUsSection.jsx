...
const newsItems = [
  {
    title: "Tăng Cường Hợp Tác Giữa Epicor Software Corporation Và TECHWORLD",
    date: "30 Mar 2026",
    excerpt: "TP.HCM – Trong khuôn khổ thúc đẩy hợp tác chiến lược tại khu vực Đông Nam Á...",
    image: "https://twi.vn/wp-content/uploads/2026/03/image-3.png",
  },
  {
    title: "TECHWORLD CHÍNH THỨC KHAI TRƯƠNG TECHWORLD ACADEMY",
    date: "12 Mar 2026",
    excerpt: "Ngày 11/03/2026 đánh dấu một cột mốc quan trọng trong hành trình phát triển của TECHWORLD...",
    image: "https://twi.vn/wp-content/uploads/2026/03/Image-2.jpg",
  },
  {
    title: "Hải Anh JSC triển khai hệ thống ERP với Techworld Solutions Vietnam",
    date: "13 Oct 2025",
    excerpt: "Hải Anh JSC triển khai hệ thống ERP với Techworld Solutions Vietnam trên nền tảng Microsoft Dynamics 365...",
    image: "https://twi.vn/wp-content/uploads/2025/10/image_2025-10-13_144643280.png",
  },
];
            ...
            {newsItems.map((item) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <h3 className="font-bold text-foreground mb-2 leading-snug line-clamp-2 group-hover:text-tw-blue transition-colors">
                    {item.title}
                  </h3>
                  <p className="text-muted-foreground text-sm line-clamp-2">{item.excerpt}</p>
                  <a href="#" className="inline-block mt-3 text-sm font-semibold text-tw-blue hover:underline">
                    Đọc Thêm →
                  </a>
                </div>
              </article>
